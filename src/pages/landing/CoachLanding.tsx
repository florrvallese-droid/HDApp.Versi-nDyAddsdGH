      ...
      <div className="min-h-screen bg-black text-white flex flex-col selection:bg-yellow-500/30 relative overflow-x-hidden">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6">
          ...
          <div className="relative z-20 max-w-5xl text-center space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            <div className="pt-8">
                <Button 
                  className="h-24 px-12 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-black font-black uppercase italic text-2xl shadow-[0_0_60px_rgba(245,158,11,0.3)] border-2 border-yellow-400/20 rounded-2xl transition-all"
                  onClick={() => {
        ...
        <section id="pricing-plans" className="py-24 md:py-32 px-6 bg-zinc-950 border-y border-zinc-900 scroll-mt-20">
          <div className="max-w-7xl mx-auto space-y-20">
              <div className="text-center space-y-4">
                  <h2 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter">GRILLA DE PRECIOS</h2>
                  <p className="text-zinc-500 font-bold uppercase text-xs tracking-[0.3em]">INVERSIÓN MENSUAL EN TU NEGOCIO</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                  ...
                  <Card className="bg-zinc-900/50 border border-zinc-800 flex flex-col overflow-hidden transition-all hover:border-zinc-700">
                      <CardHeader className="text-center pb-8 border-b border-zinc-800">
                          ...
                          <div className="pt-6">
                              <span className="text-5xl font-black text-white">$48.000</span>
                              <span className="text-zinc-600 text-xs font-bold uppercase ml-2">ARS / mes</span>
                          </div>
                          <p className="text-[11px] font-black text-zinc-500 uppercase mt-4 italic">"Dejá el Excel."</p>
                      </CardHeader>
                      <CardContent className="flex-1 space-y-5 py-10 px-8">
                      ...
                      <CardFooter className="p-8 pt-0">
                          <Button variant="outline" className="w-full h-14 border-zinc-800 text-zinc-400 hover:text-white font-black uppercase tracking-widest text-xs" onClick={() => navigate('/auth')}>EMPEZAR PRUEBA</Button>
                      </CardFooter>
                  </Card>

                  {/* PRO (RECOMENDADO) */}
                  <Card className="bg-black border-2 border-red-600 flex flex-col overflow-hidden relative shadow-[0_0_80px_rgba(220,38,38,0.15)] z-10 scale-105">
                      ...
                      <CardHeader className="text-center pb-8 border-b border-red-900/20 bg-red-600/5">
                          ...
                          <p className="text-[11px] font-black text-red-500 uppercase mt-4 italic">"Escalá tu Negocio."</p>
                      </CardHeader>
                      <CardContent className="flex-1 space-y-5 py-10 px-8">
                  ...
                  <Card className="bg-zinc-900/50 border border-zinc-800 flex flex-col overflow-hidden transition-all hover:border-zinc-700">
                      <CardHeader className="text-center pb-8 border-b border-zinc-800">
                          ...
                          <div className="pt-6">
                              <span className="text-5xl font-black text-white">$150.000</span>
                              <span className="text-zinc-600 text-xs font-bold uppercase ml-2">ARS / mes</span>
                          </div>
                          <p className="text-[11px] font-black text-zinc-500 uppercase mt-4 italic">"Dominá el Mercado."</p>
                      </CardHeader>
                      <CardContent className="flex-1 space-y-5 py-10 px-8">
                          ...
                          <Tooltip>
                              <TooltipTrigger asChild>
                                  <div className="flex items-center gap-3 cursor-help group">
                                      ...
                                      <span className="text-xs font-black uppercase tracking-widest text-blue-500 border-b border-dashed border-blue-500/50 pb-0.5">💎 Solicitud de Funciones</span>
                                  </div>
                              </TooltipTrigger>
                      ...
                      <CardFooter className="p-8 pt-0">
                          <Dialog>
                              <DialogTrigger asChild>
                                  <Button variant="outline" className="w-full h-14 border-blue-500/30 text-blue-500 hover:bg-blue-500 hover:text-white font-black uppercase tracking-widest text-xs">APLICAR AHORA</Button>
                              </DialogTrigger>
                              <DialogContent className="bg-zinc-950 border-zinc-800 text-white">
                                  <DialogHeader>
                                      <DialogTitle className="text-2xl font-black uppercase italic text-blue-500">Contacto VIP Agency</DialogTitle>
                                      <DialogDescription className="text-zinc-500 text-xs uppercase font-bold tracking-widest">Atención directa con el equipo de desarrollo</DialogDescription>
                                  </DialogHeader>
        ...
        <section className="py-24 md:py-32 px-6 bg-black border-t border-zinc-900">
          <div className="max-w-4xl mx-auto space-y-16">
              <div className="text-center space-y-2">
                  <h2 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter">PREGUNTAS FRECUENTES</h2>
                  <p className="text-zinc-500 font-bold uppercase text-[10px] tracking-[0.3em]">VISIÓN EMPRESARIAL PARA COACHES</p>
              </div>

              <Accordion type="single" collapsible className="w-full space-y-6">
                  
                  <AccordionItem value="item-1" className="border border-zinc-900 bg-zinc-900/20 rounded-3xl px-8">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-white text-left">
                  ...
                  <AccordionItem value="item-2" className="border border-zinc-900 bg-zinc-900/20 rounded-3xl px-8">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-white text-left">
                  ...
                  <AccordionItem value="item-3" className="border border-zinc-900 bg-zinc-900/20 rounded-3xl px-8">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-white text-left">
                  ...
                  <AccordionItem value="item-4" className="border border-zinc-900 bg-zinc-900/20 rounded-3xl px-8">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-white text-left">
                  ...
                  <AccordionItem value="item-5" className="border border-zinc-900 bg-zinc-900/20 rounded-3xl px-8">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-white text-left">
...
const PlanFeature = ({ text, active = true, highlight = false }: any) => (
    <div className={cn("flex items-center gap-4", !active && "opacity-20")}>
        {active ? <CheckCircle2 className={cn("h-4 w-4", highlight ? "text-red-500" : "text-zinc-600")} /> : <XCircle className="h-4 w-4 text-zinc-800" />}
        <span className={cn("text-[11px] font-black uppercase tracking-widest", active ? "text-zinc-300" : "text-zinc-800", highlight && "text-white")}>{text}</span>
    </div>
);
