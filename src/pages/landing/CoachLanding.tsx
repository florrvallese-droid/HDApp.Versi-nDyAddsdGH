        ...
        <section className="py-24 md:py-32 px-6 bg-black border-t border-zinc-900">
          <div className="max-w-4xl mx-auto space-y-16">
              ...
              <Accordion type="single" collapsible className="w-full space-y-6">
                  ...
                  {/* Q1: PRICE OBJ */}
                  <AccordionItem value="item-1" className="border border-red-600/30 bg-red-600/5 rounded-3xl px-8 shadow-[0_0_40px_rgba(220,38,38,0.05)]">
                      <AccordionTrigger className="hover:no-underline font-black uppercase italic text-base py-8 text-red-500 text-left">
