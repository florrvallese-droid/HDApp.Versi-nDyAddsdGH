...
import { Loader2, AlertTriangle, CheckCircle2, Moon, Activity, Zap, Brain, Lock } from "lucide-react";
        ...
        <DialogContent className="sm:max-w-md">
          ...
          {step === 'input' && (
            <div className="grid gap-6 py-4">
              ...
              <Button onClick={analyzeData} className="w-full mt-2 relative overflow-hidden">
